...
title=Label(entries_frame,text="Employee Management System",font=("Calibri",18,"bold"),bg="white",fg="black")
...
txtemail=Entry(entries_frame,textvariable=email,font=("Calibri",16),width="40")
...
txtcontact=Entry(entries_frame,textvariable=contact,font=("Calibri",16),width="40")
...
tree_frame.place(x=0, y=480, width=1980, height=500)
style = ttk.Style()
